package com.kalashnikov.factorial.blocks.ores;

import com.kalashnikov.factorial.Main;
import com.kalashnikov.factorial.blocks.item.ItemBlockVariants;
...
public class OreBase extends Block implements IHasModel, IMetaName{
	...
	public OreBase(String name, String dimension) {
		...
		setDefaultState(this.blockState.getBaseState().withProperty(VARIANT, EnumHandler.EnumType.IRON));
