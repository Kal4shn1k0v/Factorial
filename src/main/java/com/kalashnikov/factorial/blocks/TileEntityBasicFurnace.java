...
public class TileEntityBasicFurnace extends TileEntity implements ITickable
{
	...
	public static boolean isBurning(TileEntityBasicFurnace te) 
	{
	...
	{	
		...
		{
			--this.burnTime;
			BlockBasicFurnace.setState(true, world, pos);
		}
		...
		else
		{
			...
			{
				ItemStack output = BasicFurnaceRecipes.getInstance().getSinteringResult(inputs[0], inputs[1]);
				if(!output.isEmpty())
				{
					smelting = output;
					cookTime++;
	...
	private boolean canSmelt() 
	{
		...
		{
			ItemStack result = BasicFurnaceRecipes.getInstance().getSinteringResult((ItemStack)this.handler.getStackInSlot(0), (ItemStack)this.handler.getStackInSlot(1));	
